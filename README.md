...
| **6 · Rebuild** | Mobile and desktop artboards, from scratch, in Arial | ✅ **Complete** — [`docs/06-rebuild.md`](docs/06-rebuild.md) |
...
6. **[`docs/05-design-direction.md`](docs/05-design-direction.md)** — Stage 5.
   What the nine reference sites share, the direction that follows, and the
   rules.
7. **[`docs/06-rebuild.md`](docs/06-rebuild.md)** — Stage 6, and **what is
   actually in Figma now**. The Arial two-weight system, the variable model, the
   components, the artboards, and what the audit caught.

Arriving in later stages: `prototype/`, `docs/build-notes.md`.

### Where the design stands

**15 artboards rebuilt from scratch in Figma** — 8 mobile at 375, 7 desktop at
1440 — on **260 variables across four collections and 22 text styles**, in
Arial. Both pages audit clean: zero unbound fills, zero overflow, and all eight
mobile artboards resolving Mobile mode. Details in
[`docs/06-rebuild.md`](docs/06-rebuild.md).

The Stage 4 pages are renamed `Z · Archive — S4 …`, not deleted.
...
| **Sign-off on cream as the page ground and navy demoted to the footer** | Before the Webflow build |
